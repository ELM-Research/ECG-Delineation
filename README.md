...
We provide a simple demonstration of R-U-Net's performance compared against a rules-based method (Pan Tompkins) and human delineation annotations. Feel free to check it out by opening the `demo/index.html` file! All predictions are precomputed.
